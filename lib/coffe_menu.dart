...
var coffeeList = [
  ...
  CoffeeMenu(
    ...
    price: 'Rp26.000',
    ingredients: 'Milk , Brewed Espresso , Vanilla Syrup , Caramel Sauce',
  ...
  CoffeeMenu(
    ...
    price: 'Rp27.000',
    ingredients: 'Milk , Brewed Espresso , Mocha Sauce , Whipped Cream',
  ...
  CoffeeMenu(
    ...
    price: 'Rp27.000',
    ingredients: 'Ice , Brewed Coffee , Vanilla Sweet Cream , Vanilla Syrup',
  ...
  CoffeeMenu(
    ...
    description:
        'Chocolate and dairy milk, steamed together to create a hot chocolate fit for a chocaholic! Topped with whipped cream and dusted with cocoa.',
    price: 'Rp25.000',
    ingredients: 'Milk , Mocha Sauce , Whipped Cream',
    nutrition: '370 calories',
    reviewAverage: '88%',
    reviewCount: '9873',
  ...
  CoffeeMenu(
    ...
    price: 'Rp22.000',
    ingredients: 'Milk , Water , Chai Tea Concentrate',
  ...
  CoffeeMenu(
    ...
    price: 'Rp26.000',
    ingredients: 'Milk , Matcha Tea Blend',
    nutrition: '240 calories',
    reviewAverage: '89%',
    reviewCount: '3428',
